...
function udesign_init_styles() {
	...
	wp_enqueue_style('u-design-style', get_bloginfo('template_url') . "/styles/style1/css/style.css", false, '2.0.1', 'screen');
        ...
        if ( $udesign_responsive ) {
            wp_enqueue_style('u-design-responsive', get_bloginfo('template_url') . '/styles/common-css/responsive.css', false, '2.0.1', 'screen');
        }
